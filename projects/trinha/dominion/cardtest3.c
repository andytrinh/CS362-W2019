...
int main() {
  ...
  printf("----------------- TEST 1: Check to see if 1 card has been added----------------- \n");
  ...
  printf("----------------- TEST 2: Check to see if 2 action cards have been added----------------- \n");
  int numTreasure = 0;
  int currentCard = 0;
  for (int i = 0; i < 5; i++) {
  ...
  printf("----------------- TEST 3: Check to see that other player's values are unaffected----------------- \n");
  newCards = 0;
  discarded = 0;
